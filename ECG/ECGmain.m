...
epoch_R5(end,:) = [];
epoch_R6 = arrangeDataECG(preprocessed_R6); 
epoch_R6(end,:) = [];
epoch_R7 = arrangeDataECG(preprocessed_R7);
epoch_R7(end,:) = [];
epoch_R8 = arrangeDataECG(preprocessed_R8);
epoch_R8(end,:) = [];
epoch_R9 = arrangeDataECG(preprocessed_R9);
epoch_R10 = arrangeDataECG(preprocessed_R10);
epoch_R10(end,:) = [];
