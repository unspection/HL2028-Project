...
saveFeatures(hrv, 'hrv_features.xlsx');
saveFeatures(hrv_norm, 'hrv_norm_features.xlsx');

%% Load and arrange stages
[~, stages_R1, ~, ~] = readXML('R1.xml');
[events, stages1, epochLength,annotation]= readXML('R2.xml');
...
[knownStages, predictedStages, testAcc,...
    trainAcc] = SVMmodel(hrv_norm, stages, nSamples);
