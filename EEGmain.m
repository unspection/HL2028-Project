...
[R1_Epoch, Alpha1, Beta1, Theta1, Delta1, Gamma1] = arrangeData(filtered_EEG1, Alpha1, Beta1, Theta1, Delta1, Gamma1);
[R2_Epoch, Alpha2, Beta2, Theta2, Delta2, Gamma2] = arrangeData(filtered_EEG2, Alpha2, Beta2, Theta2, Delta2, Gamma2);
[R3_Epoch, Alpha3, Beta3, Theta3, Delta3, Gamma3] = arrangeData(filtered_EEG3, Alpha3, Beta3, Theta3, Delta3, Gamma3);
[R4_Epoch, Alpha4, Beta4, Theta4, Delta4, Gamma4] = arrangeData(filtered_EEG4, Alpha4, Beta4, Theta4, Delta4, Gamma4);
[R5_Epoch, Alpha5, Beta5, Theta5, Delta5, Gamma5] = arrangeData(filtered_EEG5, Alpha5, Beta5, Theta5, Delta5, Gamma5);
...
%% SVM model
[knownStages, predictions_test, testAcc, trainAcc] = SVMmodel(normFeatures, stages, nSamples, 'polynomial');
